...
import classes from "features/legal-notice/page/LegalNoticePage.module.scss";
    ...
    <div className={classes.wrapper}>
      ...
      <div className={classes.text}>
          ...
          <Paragraph
            text={
              <span className={classes.paragraph}>
                ...
                utilisateurs du site internet www.enolalouge.com l’identité des
                ...
                <br />
                <br /> Numéro de TVA : FR 22 898 798 285 – 31000 Toulouse <br />
        ...
        <div className={classes.text__section}>
          ...
          />
          <SubHeading text={"7.4 Non-communication des données personnelles"} />
          <Paragraph
            text={
